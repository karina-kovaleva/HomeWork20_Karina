...
class ViewController: UIViewController {
    ...
    lazy var backToMainButton: UIButton = {
        ...
        backToMainButton.frame = CGRect(x: self.viewForMenu.frame.width / 6, y: self.viewForMenu.frame.height / 2.5, width: self.viewForMenu.frame.size.width / 1.5, height: self.viewForMenu.frame.height / 15)
